    ...
    createEvents(){
        ...
        $(function () {
            ...
            let tabIn = $('.ftab-input').click(function(e) {
                ...
                $('.fconsole-body').css({display: 'none'});
                let stdout = $('.fconsole-stdin').css({display: 'block'});
            });
            ...
            self.events.push(output, resize, tabIn, tabOut, tabLog, clear, close, min, pageUp, pageDown);
        })
    }
